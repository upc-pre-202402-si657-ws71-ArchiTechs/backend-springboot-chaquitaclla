...
import open.source.agriculture.chaquitaclla.chaquitacllaplatformopen.iam.application.internal.outboundservices.outboundservices.acl.ExtProfileService;
...
public class UserCommandServiceImpl implements UserCommandService {
  ...
  private final ExtProfileService extProfileService;

  public UserCommandServiceImpl(UserRepository userRepository, HashingService hashingService,
      TokenService tokenService, RoleRepository roleRepository, @Lazy ExtProfileService extProfileService) {

    this.userRepository = userRepository;
    this.hashingService = hashingService;
    this.tokenService = tokenService;
    this.roleRepository = roleRepository;
    this.extProfileService = extProfileService;
  }
  ...
  public Optional<User> handle(SignUpCommand command) {
    ...
    Long profileId = extProfileService.fetchProfileIdByUsername(command.username());
